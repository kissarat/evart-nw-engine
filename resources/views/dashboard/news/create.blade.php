            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form method="post" action="{{ isset($Item) ? route('dashboard.news.update') : route('dashboard.news.create')}}">
                            {{csrf_field()}}
                            @if(isset($Item))
                            ...
                            @if(isset($Item))
                                <form id="deleteForm" action="{{route('dashboard.news.delete')}}" method="post" style="display: none">
                                        <input type="hidden" name="id" value="{{$Item['id']}}">
